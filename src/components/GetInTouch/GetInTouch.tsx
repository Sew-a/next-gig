            ...
            >
              ...
              <div className="interactive-text-box">
                <p className="primary-text">
                  Really, you wanna get in touch with me?
                </p>
                <p className="secondary-text">
                  If you think that you want write me message, please think
                  twice.
                </p>
              </div>
              <ActionButton
          ...
          {step === 1 && (
            ...
            >
              ...
              <div className="interactive-text-box">
                ...
                >
                  Hold up, If you still doing this it seems you got no choice,
                  ok after next hit there will be contact form.
                </motion.p>
              </div>
              <ActionButton
            ...
            >
              ...
              <div className="interactive-text-box">
                <h3 className="final-message">
                  Naah, here's my mail, text me if you need anything
                </h3>
                <a
                ...
                <p className="boring-text">
                  Sorry, I was too bored to make another contact-me form
                </p>
              </div>
            </motion.div>
          )}
